const Projects = [
    {
        ...
        Description :"A Wikipedia clone, also called a Wikipedia mirror site, is a web site that uses information derived wholly or in large part from Wikipedia...",
    ...
    },
    {
        ...
        Description :"In this weather app, you can get the weather details of a particular city by entering the city name, If you entered an invalid city name then there is shown an error message.",
    ...
    {
        Name:"Clock-Project",
        Description :"The aim of the project is to design a twelve hour Digital Clock that displays the time digitally",
    ...
    {
        Name:"Portfolio",
        Description :"The Complete Customizable Software Developer Portfolio Template which lets you showcase your work and provides each and every detail about you as Software Developer. Clone the code, make changes, run the code, deploy the app.",
